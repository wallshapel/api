<?php
    ...
    $routes->group('api', ['namespace' => 'App\Controllers\API', 'filter' => 'autFiltro'], function($routes) {
        // Cliente. La consume solo el administrador.
        ...
        // Cuenta. La consume solo el administrador.
        ...
        // Tipo de Transacciones. La consume solo el administrador.
        ...
        // Transacciones.
        $routes->get('transaccion', 'Transaccion::index');  // La consume solo el administrador.
        $routes->post('transaccion/crear', 'Transaccion::crear');  // La consumen los clientes y el administrador.
        $routes->get('transaccion/editar/?(:num)?', 'Transaccion::editar/$1');  // La consume solo el administrador. 
        $routes->put('transaccion/actualizar/?(:num)?', 'Transaccion::actualizar/$1');  // La consume solo el administrador.
        $routes->delete('transaccion/eliminar/?(:num)?', 'Transaccion::eliminar/$1');  // La consume solo el administrador.
        $routes->get('transaccion/cliente/?(:num)?', 'Transaccion::cliente/$1');  // Implementa una consulta multitabla. // La consumen los clientes y el administrador.
        // Roles. La consume solo el administrador.
        ...
        $routes->get('roles/usuario/?(:num)?', 'Roles::usuario/$1');  // Implementa una consulta multitabla.
        // Usuarios. La consume solo el administrador. 
